...
If row 1 is empty, write these headers first in row 1:
Submitted At | Requester Name | Division | Request Date | SKU/Product | Quantity | Unit | Destination | Area | Urgency | Notes | Status

Then append this data as the next available empty row:
${JSON.stringify(row)}
...
Use useUAT: true. Reply only: DONE`;
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        mcp_servers: [{
          type: 'url',
          url: 'https://seravee-lark-mcp.tentanganak.id/mcp',
          name: 'lark-ta'
        }],
